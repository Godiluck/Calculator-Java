...
public class ErrorHandler {
    ...
    public static void checkNegativeRomanResult(Integer result) throws RomanNumeralsException {
        if (result <= 0) {
            throw new RomanNumeralsException("в римской сиситеме счисления нет отрицательных чисел");
        }
    }
}
